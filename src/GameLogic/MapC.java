...
public class MapC extends Map{
     ...
     */
	 public MapC(Game g, int cellHeightPX, int cellWidthPX){
		...
		/*Column 1*/
		cells[0][0] = GhostHome.cloneInPosition(0, 0);
    	cells[1][0] = GhostHome.cloneInPosition(1, 0);
		cells[2][0] = RoadPacdot.cloneInPosition(2, 0);
		cells[3][0] = RoadPacdot.cloneInPosition(3, 0);
		cells[4][0] = RoadTeleport.cloneInPosition(4, 0);
		...
		cells[15][0] = RoadTeleport.cloneInPosition(15, 0);
		cells[16][0] = RoadPacdot.cloneInPosition(16, 0);
		cells[17][0] = RoadPacdot.cloneInPosition(17, 0);
		cells[18][0] = GhostHome.cloneInPosition(18, 0);
		cells[19][0] = GhostHome.cloneInPosition(19, 0);

		/*Column 2*/
		cells[0][1] = GhostHome.cloneInPosition(0, 1);
		cells[1][1] = GhostHome.cloneInPosition(1, 1);
		cells[2][1] = RoadPacdot.cloneInPosition(2, 1);
		cells[3][1] = Wall.cloneInPosition(3, 1);
		cells[4][1] = RoadPacdot.cloneInPosition(4, 1);
		cells[5][1] = Wall.cloneInPosition(5, 1);
		cells[6][1] = RoadPacdot.cloneInPosition(6, 1);
		cells[7][1] = Wall.cloneInPosition(7, 1);
		cells[8][1] = Wall.cloneInPosition(8,1);
		cells[9][1] = Wall.cloneInPosition(9, 1);
		cells[10][1] = Wall.cloneInPosition(10,1);
		cells[11][1] = Wall.cloneInPosition(11, 1);
		cells[12][1] = Wall.cloneInPosition(12, 1);
		cells[13][1] = RoadPacdot.cloneInPosition(13, 1);
		cells[14][1] = Wall.cloneInPosition(14, 1);
		cells[15][1] = RoadPacdot.cloneInPosition(15, 1);
		cells[16][1] = Wall.cloneInPosition(16, 1);
		cells[17][1] = RoadPacdot.cloneInPosition(17, 1);
		cells[18][1] = GhostHome.cloneInPosition(18, 1);
		cells[19][1] = GhostHome.cloneInPosition(19, 1);

		/*Column 3*/
		cells[0][2] = RoadPacdot.cloneInPosition(0, 2);
		cells[1][2] = RoadPacdot.cloneInPosition(1, 2);
		cells[2][2] = RoadFruit.cloneInPosition(2, 2);
		cells[3][2] = Wall.cloneInPosition(3, 2);
		cells[4][2] = RoadPacdot.cloneInPosition(4, 2);
		cells[5][2] = Wall.cloneInPosition(5, 2);
		...
		cells[12][2] = Wall.cloneInPosition(12, 2);
		cells[13][2] = RoadPacdot.cloneInPosition(13, 2);
		cells[14][2] = Wall.cloneInPosition(14, 2);
		cells[15][2] = RoadPacdot.cloneInPosition(15, 2);
		cells[16][2] = Wall.cloneInPosition(16, 2);
		cells[17][2] = RoadFruit.cloneInPosition(17, 2);
		cells[18][2] = RoadPacdot.cloneInPosition(18, 2);
		cells[19][2] = RoadPacdot.cloneInPosition(19, 2);
		
		/*Column 4*/
		cells[0][3] = RoadPacdot.cloneInPosition(0, 3);
		cells[1][3] = Wall.cloneInPosition(1, 3);
		cells[2][3] = Wall.cloneInPosition(2, 3);
		cells[3][3] = Wall.cloneInPosition(3, 3);
		cells[4][3] = RoadPacdot.cloneInPosition(4, 3);
		cells[5][3] = Wall.cloneInPosition(5, 3);
		cells[6][3] = RoadPacdot.cloneInPosition(6, 3);
		cells[7][3] = Wall.cloneInPosition(7, 3);
		...
		cells[13][3] = RoadPacdot.cloneInPosition(13, 3);
		...
		/*Column 5*/
		cells[0][4] = RoadTeleport.cloneInPosition(0, 4);
		cells[1][4] = RoadPacdot.cloneInPosition(1, 4);
		cells[2][4] = RoadPacdot.cloneInPosition(2, 4);
		cells[3][4] = RoadPacdot.cloneInPosition(3, 4);
		cells[4][4] = RoadPowerPellet.cloneInPosition(4, 4);
		cells[5][4] = RoadPacdot.cloneInPosition(5, 4);
		cells[6][4] = RoadPacdot.cloneInPosition(6, 4);
		cells[7][4] = Wall.cloneInPosition(7, 4);
		...
		cells[19][4] = RoadTeleport.cloneInPosition(19, 4);

		/*Column 6*/
		cells[0][5] = RoadPacdot.cloneInPosition(0, 5);
		cells[1][5] = Wall.cloneInPosition(1, 5);
		cells[2][5] = Wall.cloneInPosition(2, 5);
		cells[3][5] = Wall.cloneInPosition(3, 5);
		cells[4][5] = RoadPacdot.cloneInPosition(4, 5);
		cells[5][5] = Wall.cloneInPosition(5, 5);
		cells[6][5] = RoadPacdot.cloneInPosition(6, 5);
		cells[7][5] = Wall.cloneInPosition(7, 5);
		...
		cells[13][5] = RoadPacdot.cloneInPosition(13, 5);
		...
		/*Column 7*/
		cells[0][6] = RoadPacdot.cloneInPosition(0, 6);
		cells[1][6] = RoadPacdot.cloneInPosition(1, 6);
		cells[2][6] = RoadPacdot.cloneInPosition(2, 6);
		cells[3][6] = RoadPacdot.cloneInPosition(3, 6);
		cells[4][6] = RoadPacdot.cloneInPosition(4, 6);
		cells[5][6] = RoadPacdot.cloneInPosition(5, 6);
		cells[6][6] = RoadPacdot.cloneInPosition(6, 6);
		cells[7][6] = RoadPacdot.cloneInPosition(7, 6);
		cells[8][6] = RoadPacdot.cloneInPosition(8, 6);
		cells[9][6] = RoadPacdot.cloneInPosition(9, 6);
		cells[10][6] = RoadPacdot.cloneInPosition(10, 6);
		cells[11][6] = RoadPacdot.cloneInPosition(11, 6);
		cells[12][6] = Wall.cloneInPosition(12, 6);
		cells[13][6] = RoadPacdot.cloneInPosition(13, 6);
		cells[14][6] = RoadPacdot.cloneInPosition(14, 6);
		cells[15][6] = RoadPacdot.cloneInPosition(15, 6);
		cells[16][6] = RoadPacdot.cloneInPosition(16, 6);
		...
		/*Column 8*/
		cells[0][7] = RoadPacdot.cloneInPosition(0, 7);
		cells[1][7] = Wall.cloneInPosition(1, 7);
		cells[2][7] = RoadPacdot.cloneInPosition(2, 7);
		cells[3][7] = Wall.cloneInPosition(3, 7);
		cells[4][7] = Wall.cloneInPosition(4, 7);
		cells[5][7] = Wall.cloneInPosition(5, 7);
		cells[6][7] = RoadPacdot.cloneInPosition(6, 7);
		cells[7][7] = Wall.cloneInPosition(7, 7);
		cells[8][7] = RoadPacdot.cloneInPosition(8, 7);
		cells[9][7] = Wall.cloneInPosition(9, 7);
		cells[10][7] = RoadPacdot.cloneInPosition(10, 7);
		cells[11][7] = RoadPacdot.cloneInPosition(11, 7);
		cells[12][7] = RoadPacdot.cloneInPosition(12, 7);
		cells[13][7] = Wall.cloneInPosition(13, 7);
		cells[14][7] = Wall.cloneInPosition(14, 7);
		cells[15][7] = Wall.cloneInPosition(15, 7);
		cells[16][7] = Wall.cloneInPosition(16, 7);
		cells[17][7] = Wall.cloneInPosition(17, 7);
		cells[18][7] = Wall.cloneInPosition(18, 7);
		cells[19][7] = RoadPacdot.cloneInPosition(19, 7);
		
		/*Column 9*/
		cells[0][8] = RoadPacdot.cloneInPosition(1, 8);
		cells[1][8] = Wall.cloneInPosition(1, 8);
		cells[2][8] = RoadPacdot.cloneInPosition(2, 8);
		cells[3][8] = Wall.cloneInPosition(3, 8);
		cells[4][8] = Wall.cloneInPosition(4, 8);
		cells[5][8] = Wall.cloneInPosition(5, 8);
		cells[6][8] = RoadPacdot.cloneInPosition(6, 8);
		cells[7][8] = RoadPacdot.cloneInPosition(7, 8);
		cells[8][8] = RoadPacdot.cloneInPosition(8, 8);
		cells[9][8] = Wall.cloneInPosition(9, 8);
		cells[10][8] = RoadPacdot.cloneInPosition(10, 8);
		cells[11][8] = Wall.cloneInPosition(11, 8);
		cells[12][8] = RoadPacdot.cloneInPosition(12, 8);
		cells[13][8] = RoadPacdot.cloneInPosition(13, 8);
		cells[14][8] = RoadPacdot.cloneInPosition(14, 8);
		cells[15][8] = RoadPacdot.cloneInPosition(15, 8);
		cells[16][8] = RoadPacdot.cloneInPosition(16, 8);
		cells[17][8] = RoadPacdot.cloneInPosition(17, 8);
		cells[18][8] = Wall.cloneInPosition(18, 8);
		cells[19][8] = RoadPacdot.cloneInPosition(19, 8);

		/*Column 10*/
		cells[0][9] = RoadPacdot.cloneInPosition(0, 9);
		cells[1][9] = Wall.cloneInPosition(1, 9);
		cells[2][9] = RoadPacdot.cloneInPosition(2, 9);
		cells[3][9] = RoadPacdot.cloneInPosition(3, 9);
		...
		cells[8][9] = Wall.cloneInPosition(8, 9);
		cells[9][9] = Wall.cloneInPosition(9, 9);
		cells[10][9] = RoadSpeedPotion.cloneInPosition(10, 9);
		...
		cells[15][9] = Wall.cloneInPosition(15, 9);
		cells[16][9] = Wall.cloneInPosition(16, 9);
		...
		cells[3][10] = Wall.cloneInPosition(3, 10);
		cells[4][10] = Wall.cloneInPosition(4, 10);
		...
		cells[9][10] = RoadBombPotion.cloneInPosition(9, 10);
		cells[10][10] = Wall.cloneInPosition(10, 10);
		cells[11][10] = Wall.cloneInPosition(11, 10);
		...
		cells[16][10] = RoadPacdot.cloneInPosition(16, 10);
		cells[17][10] = RoadPacdot.cloneInPosition(17, 10);
		cells[18][10] = Wall.cloneInPosition(18, 10);
		cells[19][10] = RoadPacdot.cloneInPosition(19, 10);
		
		/*Column 12*/
		cells[0][11] = RoadPacdot.cloneInPosition(0, 11);
		cells[1][11] = Wall.cloneInPosition(1, 11);
		cells[2][11] = RoadPacdot.cloneInPosition(2, 11);
		cells[3][11] = RoadPacdot.cloneInPosition(3, 11);
		cells[4][11] = RoadPacdot.cloneInPosition(4, 11);
		cells[5][11] = RoadPacdot.cloneInPosition(5, 11);
		cells[6][11] = RoadPacdot.cloneInPosition(6, 11);
		cells[7][11] = RoadPacdot.cloneInPosition(7, 11);
		cells[8][11] = Wall.cloneInPosition(8, 11);
		cells[9][11] = RoadPacdot.cloneInPosition(9, 11);
		cells[10][11] = Wall.cloneInPosition(10, 11);
		cells[11][11] = RoadPacdot.cloneInPosition(11, 11);
		cells[12][11] = RoadPacdot.cloneInPosition(12, 11);
		cells[13][11] = RoadPacdot.cloneInPosition(13, 11);
		cells[14][11] = Wall.cloneInPosition(14, 11);
		cells[15][11] = Wall.cloneInPosition(15, 11);
		cells[16][11] = Wall.cloneInPosition(16, 11);
		cells[17][11] = RoadPacdot.cloneInPosition(17, 11);
		cells[18][11] = Wall.cloneInPosition(18, 11);
		cells[19][11] = RoadPacdot.cloneInPosition(19, 11);
		
		/*Column 13*/
		cells[0][12] = RoadPacdot.cloneInPosition(0, 12);
		cells[1][12] = Wall.cloneInPosition(1, 12);
		cells[2][12] = Wall.cloneInPosition(2, 12);
		cells[3][12] = Wall.cloneInPosition(3, 12);
		cells[4][12] = Wall.cloneInPosition(4, 12);
		cells[5][12] = Wall.cloneInPosition(5, 12);
		cells[6][12] = Wall.cloneInPosition(6, 12);
		cells[7][12] = RoadPacdot.cloneInPosition(7, 12);
		cells[8][12] = RoadPacdot.cloneInPosition(8, 12);
		cells[9][12] = RoadPacdot.cloneInPosition(9, 12);
		cells[10][12] = Wall.cloneInPosition(10, 12);
		cells[11][12] = RoadPacdot.cloneInPosition(11, 12);
		cells[12][12] = Wall.cloneInPosition(12, 12);
		cells[13][12] = RoadPacdot.cloneInPosition(13, 12);
		cells[14][12] = Wall.cloneInPosition(14, 12);
		cells[15][12] = Wall.cloneInPosition(15, 12);
		cells[16][12] = Wall.cloneInPosition(16, 12);
		cells[17][12] = RoadPacdot.cloneInPosition(17, 12);
		cells[18][12] = Wall.cloneInPosition(18, 12);
		cells[19][12] = RoadPacdot.cloneInPosition(19, 12);
		...
		cells[3][13] = RoadPacdot.cloneInPosition(3, 13);
		cells[4][13] = RoadPacdot.cloneInPosition(4, 13);
		cells[5][13] = RoadPacdot.cloneInPosition(5, 13);
		cells[6][13] = RoadPacdot.cloneInPosition(6, 13);
		cells[7][13] = Wall.cloneInPosition(7, 13);
		cells[8][13] = RoadPacdot.cloneInPosition(8, 13);
		cells[9][13] = RoadPacdot.cloneInPosition(9, 13);
		cells[10][13] = RoadPacdot.cloneInPosition(10, 13);
		cells[11][13] = RoadPacdot.cloneInPosition(11, 13);
		cells[12][13] = RoadPacdot.cloneInPosition(12, 13);
		cells[13][13] = RoadPacdot.cloneInPosition(13, 13);
		cells[14][13] = RoadPacdot.cloneInPosition(14, 13);
		cells[15][13] = RoadPacdot.cloneInPosition(15, 13);
		cells[16][13] = RoadPacdot.cloneInPosition(16, 13);
		cells[17][13] = RoadPacdot.cloneInPosition(17, 13);
		cells[18][13] = RoadPacdot.cloneInPosition(18, 13);
		cells[19][13] = RoadPacdot.cloneInPosition(19, 13);
		...
		cells[6][14] = RoadPacdot.cloneInPosition(6, 14);
		...
		cells[12][14] = Wall.cloneInPosition(12, 14);
		cells[13][14] = RoadPacdot.cloneInPosition(13, 14);
		cells[14][14] = Wall.cloneInPosition(14, 14);
		cells[15][14] = RoadPacdot.cloneInPosition(15, 14);
		cells[16][14] = Wall.cloneInPosition(16, 14);
		cells[17][14] = Wall.cloneInPosition(17, 14);
		cells[18][14] = Wall.cloneInPosition(18, 14);
		cells[19][14] = RoadPacdot.cloneInPosition(19, 14);

		/*Column 16*/
		cells[0][15] = RoadTeleport.cloneInPosition(0, 15);
		...
		cells[12][15] = Wall.cloneInPosition(12, 15);
		cells[13][15] = RoadPacdot.cloneInPosition(13, 15);
		cells[14][15] = RoadPacdot.cloneInPosition(14, 15);
		cells[15][15] = RoadPowerPellet.cloneInPosition(15, 15);
		cells[16][15] = RoadPacdot.cloneInPosition(16, 15);
		cells[17][15] = RoadPacdot.cloneInPosition(17, 15);
		cells[18][15] = RoadPacdot.cloneInPosition(18, 15);
		cells[19][15] = RoadTeleport.cloneInPosition(19, 15);
		...
		cells[6][16] = RoadPacdot.cloneInPosition(6, 16);
		...
		cells[12][16] = Wall.cloneInPosition(12, 16);
		cells[13][16] = RoadPacdot.cloneInPosition(13, 16);
		cells[14][16] = Wall.cloneInPosition(14, 16);
		cells[15][16] = RoadPacdot.cloneInPosition(15, 16);
		cells[16][16] = Wall.cloneInPosition(16, 16);
		cells[17][16] = Wall.cloneInPosition(17, 16);
		cells[18][16] = Wall.cloneInPosition(18, 16);
		cells[19][16] = RoadPacdot.cloneInPosition(19, 16);

		/*Column 18*/
		cells[0][17] = RoadPacdot.cloneInPosition(0, 17);
		cells[1][17] = RoadPacdot.cloneInPosition(1, 17);
		cells[2][17] = RoadFruit.cloneInPosition(2, 17);
		cells[3][17] = Wall.cloneInPosition(3, 17);
		cells[4][17] = RoadPacdot.cloneInPosition(4, 17);
		cells[5][17] = Wall.cloneInPosition(5, 17);
		cells[6][17] = RoadPacdot.cloneInPosition(6, 17);
		cells[7][17] = Wall.cloneInPosition(7, 17);
		...
		cells[14][17] = Wall.cloneInPosition(14, 17);
		cells[15][17] = RoadPacdot.cloneInPosition(15, 17);
		cells[16][17] = Wall.cloneInPosition(16, 17);
		cells[17][17] = RoadFruit.cloneInPosition(17, 17);
		cells[18][17] = RoadPacdot.cloneInPosition(18, 17);
		cells[19][17] = RoadPacdot.cloneInPosition(19, 17);
		
		/*Column 19*/
		cells[0][18] = GhostHome.cloneInPosition(0, 18);
		cells[1][18] = GhostHome.cloneInPosition(1, 18);
		cells[2][18] = RoadPacdot.cloneInPosition(2, 18);
		...
		cells[9][18] = Wall.cloneInPosition(9,18);
		cells[10][18] = Wall.cloneInPosition(10, 18);
		cells[11][18] = Wall.cloneInPosition(11,18);
		cells[12][18] = Wall.cloneInPosition(12, 18);
		cells[13][18] = RoadPacdot.cloneInPosition(13, 18);
		cells[14][18] = Wall.cloneInPosition(14, 18);
		cells[15][18] = RoadPacdot.cloneInPosition(15, 18);
		cells[16][18] = Wall.cloneInPosition(16, 18);
		cells[17][18] = RoadPacdot.cloneInPosition(17, 18);
		cells[18][18] = GhostHome.cloneInPosition(18, 18);
		cells[19][18] = GhostHome.cloneInPosition(19, 18);
		
		/*Column 20*/
		cells[0][19] = GhostHome.cloneInPosition(0, 19);
		cells[1][19] = GhostHome.cloneInPosition(1, 19);
		cells[2][19] = RoadPacdot.cloneInPosition(2, 19);
		cells[3][19] = RoadPacdot.cloneInPosition(3, 19);
		cells[4][19] = RoadTeleport.cloneInPosition(4, 19);
		...
		cells[15][19] = RoadTeleport.cloneInPosition(15, 19);
		cells[16][19] = RoadPacdot.cloneInPosition(16, 19);
		cells[17][19] = RoadPacdot.cloneInPosition(17, 19);
		cells[18][19] = GhostHome.cloneInPosition(18, 19);
		cells[19][19] = GhostHome.cloneInPosition(19, 19);
